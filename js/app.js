(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
            ...
            if (document.querySelector(".body-main-slider")) new core(".body-main-slider", {
                ...
                on: {
                    init: function() {
                        ...
                        controll.forEach(((element, index) => {
                            let num;
                            if (index < 10) num = `0`;
                            element.innerHTML = `${num}${index + 1}`;
                        }));
                    }
                }
            });
        ...
        smooth_scroll_polyfills_min(`a[href*="#top"]`);
...
***************************************************************************** */
        ...
        document.querySelector(".video-module").addEventListener("click", (function(e) {
            if (!document.querySelector(".video-module").classList.contains(`_init`)) {
                document.querySelector(".video-module").querySelector(`video`).src = document.querySelector(".video-module").querySelector("video").dataset.full;
                document.querySelector(".video-module").classList.add(`_active`);
                document.querySelector(".video-module").classList.add(`_init`);
                ...
                if (document.querySelector(".video-module").querySelector(`video`).paused) document.querySelector(".video-module").querySelector(`video`).play(); else document.querySelector(".video-module").querySelector(`video`).pause();
                document.querySelector(".video-module").classList.toggle(`_active`);
            }
        }));
        window["FLS"] = true;
        isWebp();
